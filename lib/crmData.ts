...
export const SAMPLE_ACCOUNTS: Account[] = [
  {
    ...
    tasks: [
      { id: 't1', title: 'Send RFP response for Core Banking', status: 'In progress', priority: 'Critical', dueDate: '2026-06-20', assignee: 'Priya Nair', opportunityId: 'opp1', createdAt: 1718000000000 },
      { id: 't2', title: 'Schedule executive briefing with Arjun Kapoor', status: 'To do', priority: 'High', dueDate: '2026-06-17', assignee: 'Priya Nair', createdAt: 1718001000000 },
      { id: 't3', title: 'Share CDP case studies with Sunita Rao', status: 'Done', priority: 'Medium', dueDate: '2026-06-10', assignee: 'Dev Sharma', opportunityId: 'opp2', createdAt: 1717900000000 },
      { id: 't4', title: 'Align on contract terms with Rahul Mehta', status: 'To do', priority: 'High', dueDate: '2026-07-01', assignee: 'Priya Nair', opportunityId: 'opp1', createdAt: 1718002000000 },
      { id: 't5', title: 'QBR preparation — Q2 business review deck', status: 'To do', priority: 'Medium', dueDate: '2026-06-25', assignee: 'Dev Sharma', createdAt: 1718003000000 },
    ],
  ...
  },
  {
    ...
    tasks: [
      { id: 't6', title: 'Finalize SOW for Phase 3', status: 'In progress', priority: 'Critical', dueDate: '2026-06-18', assignee: 'Dev Sharma', opportunityId: 'opp3', createdAt: 1718010000000 },
      { id: 't7', title: 'Demo real-time tracking prototype to Meera', status: 'To do', priority: 'High', dueDate: '2026-07-05', assignee: 'Dev Sharma', opportunityId: 'opp4', createdAt: 1718011000000 },
      { id: 't8', title: 'Resolve Phase 2 WMS bugs before new contract sign', status: 'Blocked', priority: 'Critical', dueDate: '2026-06-15', assignee: 'Tech Team', createdAt: 1718012000000 },
      { id: 't9', title: 'Send invoice for WMS Phase 2 milestone 3', status: 'Done', priority: 'Low', dueDate: '2026-06-05', assignee: 'Finance', createdAt: 1717800000000 },
    ],
  ...
  },
  {
    ...
    tasks: [
      { id: 't10', title: 'Complete security questionnaire from Simran Joshi', status: 'In progress', priority: 'High', dueDate: '2026-06-19', assignee: 'Tanvi Kapila', opportunityId: 'opp6', createdAt: 1718020000000 },
      { id: 't11', title: 'Draft DPDP compliance proposal', status: 'Done', priority: 'High', dueDate: '2026-06-12', assignee: 'Tanvi Kapila', opportunityId: 'opp6', createdAt: 1718021000000 },
      { id: 't12', title: 'Set up PoC environment for Arun Pillai', status: 'To do', priority: 'Medium', dueDate: '2026-07-10', assignee: 'Tech Team', opportunityId: 'opp5', createdAt: 1718022000000 },
      { id: 't13', title: 'Introduce Dr. Verma to our CMO — build exec relationship', status: 'To do', priority: 'Low', dueDate: '2026-06-30', assignee: 'Tanvi Kapila', createdAt: 1718023000000 },
    ],
  ...
  },
  {
    ...
    tasks: [
      { id: 't14', title: 'Get signed MSA from Kabir', status: 'In progress', priority: 'Critical', dueDate: '2026-06-16', assignee: 'Priya Nair', opportunityId: 'opp7', createdAt: 1718030000000 },
      { id: 't15', title: 'Coordinate onboarding timeline with Zara', status: 'To do', priority: 'Medium', dueDate: '2026-06-22', assignee: 'Dev Sharma', opportunityId: 'opp7', createdAt: 1718031000000 },
    ],
